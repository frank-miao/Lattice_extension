...
本仓库收录基于 Lattice Local API 构建的社区插件与扩展功能。欢迎使用、提交 PR、参与贡献。

项目主页：[Lattice](https://stringer07.github.io/Lattice_release/)

## 已有插件

### Word 插件

在 Microsoft Word 中直接搜索 Lattice 文献库、插入引用并生成参考文献列表。
...
Local API 文档见 [LocalAPI_docs/Chinese/总览.md](./LocalAPI_docs/Chinese/总览.md)。
